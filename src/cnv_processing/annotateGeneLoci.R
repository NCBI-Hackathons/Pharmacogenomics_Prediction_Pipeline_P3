...
for(i in 28:length(cellLinesChrRegionBasedGeneList)){
...
cellLinesGeneSeqMeanMatrix <- extractSegMeanExprsMatrix(cellLineGenesAssMaxSegMeansList)
save(cellLinesGeneSeqMeanMatrix, file ="./objs/cellLinesGeneSeqMeanMatrix.rda")
load(file ="./objs/cellLinesGeneSeqMeanMatrix.rda")

write.table(cellLinesGeneMatrix, file="./text/cellLinesGeneSeqMeanMatrix.tsv")
